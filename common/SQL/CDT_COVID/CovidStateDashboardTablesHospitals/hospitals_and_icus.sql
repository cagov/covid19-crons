...
select
    ...
    HOSPITALIZED_PATIENTS - HOSPITALIZED_PATIENTS_PREV_WEEK  AS HOSPITALIZED_PATIENTS_WEEKLY_CHANGE,
    ZEROIFNULL(HOSPITALIZED_PATIENTS_CHANGE / NULLIFZERO(HOSPITALIZED_PATIENTS_PREV)) AS HOSPITALIZED_PATIENTS_CHANGE_FACTOR,
    ZEROIFNULL(HOSPITALIZED_PATIENTS_WEEKLY_CHANGE / NULLIFZERO(HOSPITALIZED_PATIENTS_PREV_WEEK))) AS HOSPITALIZED_PATIENTS_WEEKLY_CHANGE_FACTOR,
    ...
    ADMITTED_PATIENTS - ADMITTED_PATIENTS_PREV_WEEK AS ADMITTED_PATIENTS_WEEKLY_CHANGE,
    ZEROIFNULL(ADMITTED_PATIENTS_CHANGE / NULLIFZERO(ADMITTED_PATIENTS_PREV)) AS ADMITTED_PATIENTS_CHANGE_FACTOR,
    ZEROIFNULL(ADMITTED_PATIENTS_WEEKLY_CHANGE / NULLIFZERO(ADMITTED_PATIENTS_PREV_WEEK))) AS ADMITTED_PATIENTS_WEEKLY_CHANGE_FACTOR,
    ...
    ICU_PATIENTS - ICU_PATIENTS_PREV_WEEK  AS ICU_PATIENTS_WEEKLY_CHANGE,
    ZEROIFNULL(ICU_PATIENTS_CHANGE / NULLIFZERO(ICU_PATIENTS_PREV)) AS ICU_PATIENTS_CHANGE_FACTOR,
    ZEROIFNULL(ICU_PATIENTS_WEEKLY_CHANGE / NULLIFZERO(ICU_PATIENTS_PREV_WEEK)) AS ICU_PATIENTS_WEEKLY_CHANGE_FACTOR,
    ...
    ICU_AVAILABLE_BEDS - ICU_AVAILABLE_BEDS_PREV_WEEK  AS ICU_AVAILABLE_BEDS_WEEKLY_CHANGE,
    ZEROIFNULL(ICU_AVAILABLE_BEDS_CHANGE / NULLIFZERO(ICU_AVAILABLE_BEDS_PREV)) AS ICU_AVAILABLE_BEDS_CHANGE_FACTOR,
    ZEROIFNULL(ICU_AVAILABLE_BEDS_WEEKLY_CHANGE / NULLIFZERO(ICU_AVAILABLE_BEDS_PREV_WEEK)) AS ICU_AVAILABLE_BEDS_WEEKLY_CHANGE_FACTOR
from
