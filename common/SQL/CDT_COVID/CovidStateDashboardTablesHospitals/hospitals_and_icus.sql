...
rootData AS (
    select
        ...
        IFNULL(SUM(STAFFED_ICU_ADULT_PATIENTS_CONFIRMED_COVID),0) + IFNULL(SUM(STAFFED_ICU_PEDIATRIC_PATIENTS_CONFIRMED_COVID),0) AS ICU_PATIENTS,
        IFNULL(SUM(TOTAL_ADULT_PATIENTS_HOSPITALIZED_CONFIRMED_COVID),0) + IFNULL(SUM(TOTAL_PEDIATRIC_PATIENTS_HOSPITALIZED_CONFIRMED_COVID),0) AS HOSPITALIZED_PATIENTS,
        IFNULL(SUM(TOTAL_STAFFED_ICU_BEDS),0) - IFNULL(SUM(STAFFED_ICU_BED_OCCUPANCY),0) as ICU_AVAILABLE_BEDS
    from
