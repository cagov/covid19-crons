...
HOSPITALIZATIONS as (
    select REPORTING_FOR_DATE as REPORTING_FOR_DATE
      , SUM(TOTAL_ADULT_PATIENTS_HOSPITALIZED_CONFIRMED_COVID) AS HOSPITALIZED_COVID_CONFIRMED_PATIENTS
      , null AS HOSPITALIZED_SUSPECTED_COVID_PATIENTS
      , SUM(STAFFED_ICU_ADULT_PATIENTS_CONFIRMED_COVID) AS ICU_COVID_CONFIRMED_PATIENTS
