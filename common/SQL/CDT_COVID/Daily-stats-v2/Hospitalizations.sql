...
select TOP 1 SF_LOAD_TIMESTAMP
    ...
    ,NULL AS HOSPITALIZED_SUSPECTED_COVID_PATIENTS
    ,NULL AS HOSPITALIZED_SUSPECTED_COVID_PATIENTS_DAILY
    ,NULL AS HOSPITALIZED_SUSPECTED_COVID_PATIENTS_DAILYPCTCHG
    ,NULL AS HOSPITALIZED_SUSPECTED_COVID_PATIENTS_LAST14DAYS
    ...
    ,NULL AS ICU_SUSPECTED_COVID_PATIENTS
    ,NULL AS ICU_SUSPECTED_COVID_PATIENTS_DAILY
    ,NULL AS ICU_SUSPECTED_COVID_PATIENTS_DAILYPCTCHG
    ,NULL AS ICU_SUSPECTED_COVID_PATIENTS_LAST14DAYS
