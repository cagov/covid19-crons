...
//   const rowVaccines = resultsVaccines[0];
  ...
  const json = {
      ...
      data: {
          ...
          hospitalizations : {
              DATE : rowHospitals.REPORTING_FOR_DATE,
              ...
              HOSPITALIZED_COVID_CONFIRMED_PATIENTS_7_DAY_AVG : rowHospitals.HOSPITALIZED_COVID_CONFIRMED_PATIENTS_7_DAY_AVG,
              HOSPITALIZED_COVID_CONFIRMED_PATIENTS_PER_100K : rowHospitals.HOSPITALIZED_COVID_CONFIRMED_PATIENTS_PER_100K,
              ADMITTED_COVID_CONFIRMED_PATIENTS : rowHospitals.ADMITTED_COVID_CONFIRMED_PATIENTS,
              ADMITTED_COVID_CONFIRMED_PATIENTS_DAILY : rowHospitals.ADMITTED_COVID_CONFIRMED_PATIENTS_DAILY,
              ADMITTED_COVID_CONFIRMED_PATIENTS_DAILYPCTCHG : roundNumber(100.0*rowHospitals.ADMITTED_COVID_CONFIRMED_PATIENTS_DAILYPCTCHG,6),
              ADMITTED_COVID_CONFIRMED_PATIENTS_LAST14DAYS : rowHospitals.ADMITTED_COVID_CONFIRMED_PATIENTS_LAST14DAYS,
              ADMITTED_COVID_CONFIRMED_PATIENTS_7_DAY_AVG : rowHospitals.ADMITTED_COVID_CONFIRMED_PATIENTS_7_DAY_AVG,
              ADMITTED_COVID_CONFIRMED_PATIENTS_PER_100K : rowHospitals.ADMITTED_COVID_CONFIRMED_PATIENTS_PER_100K,
              ...
              TOTAL_HOSPITALIZED_COVID_CONFIRMED_PATIENTS : rowHospitals.TOTAL_HOSPITALIZED_COVID_CONFIRMED_PATIENTS,
              POPULATION : rowHospitals.TOTAL_POPULATION
          },
          icu : {
              DATE : rowHospitals.REPORTING_FOR_DATE,
